...
""" Efetch wrapper: return formatted data records for a list of input UIDs.
    ...
    You need to build the STing index using complete AMR gene sequences. This
    script searches NCBI using the gene names provided by Jo and downloads the
    nucleotide gene sequences in fasta format
